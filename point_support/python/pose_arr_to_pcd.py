...
def main():
    out_file_name = "../pcd_files/pose.pcd"

    poses = PoseArray()

    new_pose1 = Pose()
    new_pose1.position.x = 1.0
    new_pose1.position.y = 1.2
    new_pose1.position.z = 1.4
    new_pose1.orientation.x = 2.0
    new_pose1.orientation.y = 2.2
    new_pose1.orientation.z = 2.4
    new_pose1.orientation.w = 2.6

    new_pose2 = Pose()
    new_pose2.position.x = -1.0
    new_pose2.position.y = -1.2
    new_pose2.position.z = -1.4
    new_pose2.orientation.x = -2.0
    new_pose2.orientation.y = -2.2
    new_pose2.orientation.z = -2.4
    new_pose2.orientation.w = -2.6

    poses.poses.append(new_pose1)
    poses.poses.append(new_pose2)

    write_file(out_file_name, poses)
